        ...
        <Container>
            <div className='checkout'>
                <Row xs={1} md={1} xl={2} className=''>
                    <Col xl={7} className='checkout__info c-flex g-2 pl-1'  >
                    ...
                    <Col xl={5} className='checkout__order'>
                        <p className='checkout__info-order'>Thông tin sản phẩm:</p>
                        ...
                        <div className="bill">
                            ...
                            <div className='checkout__order-price'><p>Giảm giá (Voucher): </p><p>- 0đ</p></div>
                        ...
                        <FormControl sx={{ m: 1, minWidth: 120 }} size="larget">
                            <Select
                            ...
                            >
                                ...
                                <MenuItem value={"2"}>Thanh toán qua ví VNPay</MenuItem>
